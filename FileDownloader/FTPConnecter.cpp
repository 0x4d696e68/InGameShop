											  ...
											  ULONGLONG& nFileLength)
{
	...
	{
		this->m_Result.SetResult(DL_GET_FILE_LENGTH,ERROR_SUCCESS,"[FTPConnecter::OpenRemoteFile] Fail : FtpFindFirstFile, FileName = %s",this->m_pFileInfo->GetRemoteFilePath());
	}
